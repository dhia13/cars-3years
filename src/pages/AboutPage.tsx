              ...
              <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
                <ScrollReveal>
                  ...
                  <p className="text-gray-600">
                    Aujourd'hui, DzAuto est fière d'avoir accompagné plus de 500 clients dans leur projet d'acquisition de véhicules premium, avec un taux de satisfaction exceptionnel qui témoigne de notre engagement envers l'excellence.
                  </p>
                </ScrollReveal>
              </div>
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-gray-600">
                  Chez DzAuto, nous nous engageons à offrir un service d'excellence à chaque étape du processus d'exportation.
                </p>
              </div>
            </ScrollReveal>
